...
On Day 7, you gave it the web. Your Claw can browse live pages using Vercel's `agent-browser`, reading them through accessibility snapshots and extracting current information. You wrote security rules for handling web content.
